...
Version  : 22.12.2
Release  : 49
URL      : https://download.kde.org/stable/release-service/22.12.2/src/kbounce-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/kbounce-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/kbounce-22.12.2.tar.xz.sig
...
%prep
%setup -q -n kbounce-22.12.2
cd %{_builddir}/kbounce-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676834975
mkdir -p clr-build
pushd clr-build
