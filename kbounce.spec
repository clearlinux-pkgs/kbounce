...
Version  : 22.08.0
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kbounce-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kbounce-22.08.0.tar.xz
...
%prep
%setup -q -n kbounce-22.08.0
cd %{_builddir}/kbounce-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661548771
mkdir -p clr-build
pushd clr-build
