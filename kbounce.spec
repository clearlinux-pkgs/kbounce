...
Version  : 23.08.4
Release  : 61
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kbounce-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kbounce-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kbounce-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kbounce-23.08.4
cd %{_builddir}/kbounce-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702995942
mkdir -p clr-build
pushd clr-build
