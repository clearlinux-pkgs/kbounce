...
Version  : 21.08.2
Release  : 32
URL      : https://download.kde.org/stable/release-service/21.08.2/src/kbounce-21.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/kbounce-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/kbounce-21.08.2.tar.xz.sig
...
%prep
%setup -q -n kbounce-21.08.2
cd %{_builddir}/kbounce-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634362136
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbounce-21.08.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kbounce/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kbounce-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kbounce/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang kbounce
