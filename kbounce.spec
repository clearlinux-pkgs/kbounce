...
Version  : 23.08.5
Release  : 62
URL      : https://download.kde.org/stable/release-service/23.08.5/src/kbounce-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kbounce-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kbounce-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kbounce-23.08.5
cd %{_builddir}/kbounce-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708407061
mkdir -p clr-build
pushd clr-build
