...
Version  : 25.04.2
Release  : 82
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kbounce-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kbounce-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kbounce-25.04.2.tar.xz.sig
...
%setup -q -n kbounce-25.04.2
cd %{_builddir}/kbounce-25.04.2
pushd ..
cp -a kbounce-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749513150
mkdir -p clr-build
pushd clr-build
