...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kbounce-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kbounce-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kbounce-24.02.1
cd %{_builddir}/kbounce-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711081496
mkdir -p clr-build
pushd clr-build
