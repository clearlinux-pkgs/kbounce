...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kbounce-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kbounce-24.12.0.tar.xz.sig
...
%setup -q -n kbounce-24.12.0
cd %{_builddir}/kbounce-24.12.0
pushd ..
cp -a kbounce-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735227398
mkdir -p clr-build
pushd clr-build
