...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/kbounce-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/kbounce-23.08.0.tar.xz.sig
...
%prep
%setup -q -n kbounce-23.08.0
cd %{_builddir}/kbounce-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693022670
mkdir -p clr-build
pushd clr-build
