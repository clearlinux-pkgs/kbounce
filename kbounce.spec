...
Version  : 22.12.0
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.12.0/src/kbounce-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kbounce-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kbounce-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kbounce-22.12.0
cd %{_builddir}/kbounce-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670535327
mkdir -p clr-build
pushd clr-build
