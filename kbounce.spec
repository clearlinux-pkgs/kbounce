...
Version  : 24.08.1
Release  : 73
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kbounce-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kbounce-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kbounce-24.08.1.tar.xz.sig
...
%setup -q -n kbounce-24.08.1
cd %{_builddir}/kbounce-24.08.1
pushd ..
cp -a kbounce-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726188956
mkdir -p clr-build
pushd clr-build
