...
Version  : 19.08.1
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.1/src/kbounce-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/kbounce-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/kbounce-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567696373
mkdir -p clr-build
pushd clr-build
