...
Version  : 22.08.3
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.3/src/kbounce-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kbounce-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kbounce-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kbounce-22.08.3
cd %{_builddir}/kbounce-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667879415
mkdir -p clr-build
pushd clr-build
