...
Version  : 24.05.1
Release  : 68
URL      : https://download.kde.org/stable/release-service/24.05.1/src/kbounce-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kbounce-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kbounce-24.05.1.tar.xz.sig
...
%setup -q -n kbounce-24.05.1
cd %{_builddir}/kbounce-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718410141
mkdir -p clr-build
pushd clr-build
