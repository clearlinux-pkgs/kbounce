...
Version  : 20.12.0
Release  : 25
URL      : https://download.kde.org/stable/release-service/20.12.0/src/kbounce-20.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kbounce-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kbounce-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kbounce-20.12.0
cd %{_builddir}/kbounce-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607712010
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbounce-20.12.0/COPYING %{buildroot}/usr/share/package-licenses/kbounce/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kbounce-20.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kbounce/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kbounce-20.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kbounce/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
%find_lang kbounce
