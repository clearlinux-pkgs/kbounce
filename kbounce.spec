...
Version  : 19.04.2
Release  : 9
URL      : https://download.kde.org/stable/applications/19.04.2/src/kbounce-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/kbounce-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/kbounce-19.04.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1559884856
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
