...
Version  : 19.12.3
Release  : 18
URL      : https://download.kde.org/stable/release-service/19.12.3/src/kbounce-19.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kbounce-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kbounce-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kbounce-19.12.3
cd %{_builddir}/kbounce-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583438406
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbounce-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/kbounce/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kbounce-19.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kbounce/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kbounce-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kbounce/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
%find_lang kbounce
